...
contract MetaVestControllerTest is Test {
    ...
    function setUp() public {
        ...
        token.mint(authority, 1000000e18);
        paymentToken.mint(authority, 1000000e18);
    }
    ...
    function testUpdateExercisePrice() public {
       ...
       // assertEq(IPriceAllocation(tokenOptionAllocation).exercisePrice(), 2e18);
    }
    ...
    function testAddMilestone() public {
       ...
       // BaseAllocation.Milestone memory addedMilestone = BaseAllocation(vestingAllocation).milestones(1);
    ...
    function testUpdateStopTimes() public {
        ...
        // Note: You'll need to add getter functions in your BaseAllocation contract to verify these values
    }
    ...
    function testRepurchaseTokens() public {
        ...
        uint256 repurchaseAmount = 500e18;
        uint256 repurchasePrice = RestrictedTokenAward(restrictedTokenAward).repurchasePrice();
        uint256 payment = repurchaseAmount * repurchasePrice;
        
        paymentToken.approve(address(controller), payment);
        controller.repurchaseMetavestTokens(restrictedTokenAward, repurchaseAmount);
        
        assertEq(token.balanceOf(authority), repurchaseAmount);
    }
