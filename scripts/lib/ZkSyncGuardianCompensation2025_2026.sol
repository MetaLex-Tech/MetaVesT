...
library ZkSyncGuardianCompensation2025_2026 {
    ...
    function getDefault() internal returns(ZkSyncGuardianCompensation2024_2025.Config memory) {
        ZkSyncGuardianCompensation2024_2025.Config memory config = ZkSyncGuardianCompensation2024_2025.getDefault();
        ...
        config.zkCappedMinter = IZkCappedMinterV2(0x1358F460bD147C4a6BfDaB75aD2B78C837a11D4A);

        // zkSync Guardian Compensation Agreement

        config.metavestVestingAndUnlockStartTime = 1756684800; // 2025/09/01 00:00 UTC
