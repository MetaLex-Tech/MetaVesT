...
contract RestrictedTokenFactory is IAllocationFactory {
    ...
    function createAllocation(
       ...
       if (_allocationType == AllocationType.RestrictedToken) {
            return address(new RestrictedTokenAward(_grantee, _desiredRecipient, _controller, _paymentToken, _exercisePrice, _shortStopDuration, _allocation, _milestones));
        } else {
