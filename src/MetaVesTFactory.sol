...
contract MetaVesTFactory {
    ...
    function deployMetavestAndController(address _authority, address _dao, address _vestingAllocationFactory, address _tokenOptionFactory, address _restrictedTokenFactory, address _ZkCappedMinter ) external returns(address) {
        ...
        metavestController _controller = new metavestController(_authority, _dao, _vestingAllocationFactory, _tokenOptionFactory, _restrictedTokenFactory, _ZkCappedMinter);
