...
contract MetaVesTFactory {
    ...
    function deployMetavestAndController(
        ...
        metavestController _controller = new metavestController(_authority, _dao, _recipientOverride, _vestingAllocationFactory, _tokenOptionFactory, _restrictedTokenFactory);
        emit MetaVesT_Deployment(address(0), _authority, address(_controller), _dao, _recipientOverride, _vestingAllocationFactory, _tokenOptionFactory, _restrictedTokenFactory);
