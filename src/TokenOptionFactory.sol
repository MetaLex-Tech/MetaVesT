    ...
    function createAllocation(
        ...
        uint256 _shortStopDuration
         ...
         if (_allocationType == AllocationType.TokenOption) {
            return address(new TokenOptionAllocation(_grantee, _desiredRecipient, _controller, _paymentToken, _exercisePrice, _shortStopDuration, _allocation, _milestones));
        } else {
