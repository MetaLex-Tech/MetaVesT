...
contract metavestController is SafeTransferLib {
    ...
    function proposeMajorityMetavestAmendment(
        ...
        if ((functionToSetMajorityProposal[_msgSig][setName].isPending && block.timestamp > functionToSetMajorityProposal[_msgSig][setName].time) || setMajorityVoteActive[setName])
